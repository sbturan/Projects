...
$conn6 = mysqli_connect(DB_SERVERNAME, DB_USER_NAME, DB_PASSwORD);
if (!$conn6) {
	die("Connection failed: " . mysqli_connect_error());
}
...
<label>COMBOBOXLAR</label> <br><br><br>
		<div style="  margin-left: 30%;">
			...
			<select id="cmbMake" name="Make" >
				...
				<option value="7">Harcama Durum</option>
	...
	<div id="datagrid5" class="datagrid" >
		...
		<table id="firmaTable6">
                ...
                $sql = "SELECT  banka_id id ,banka_adi ad,aktif,
					CASE aktif WHEN '1' THEN 'AKTIF'
								WHEN '0' THEN 'PASİF'
								ELSE NULL END durum FROM ".DB_SCHEMA_NAME.".bankalar"; 
		...
		<div id="datagrid7" class="datagrid" >
		<table id="firmaTable7">
				<tr id="firstRow">
					<th>
					DURUM DEĞİŞTİR
					</th>
				...
				$sql = "SELECT  id id ,harcama_adi ad,aktif,
					CASE aktif WHEN '1' THEN 'AKTIF'
								WHEN '0' THEN 'PASİF'
								ELSE NULL END durum FROM ".DB_SCHEMA_NAME.".harcama_durum";
