...
var MESSAGES = {
    ...
    "photoviewer.toolbar.first": "Ilk Resmi Goster (Kisa Yol: Home Tusu)",
    "photoviewer.toolbar.prev": "Once ki Resim (Kisa Yol: Sol Ok)",
    "photoviewer.toolbar.slideShow": "Slide Show olarak goruntule(Kisa Yol: Bosluk Tusu)",
    "photoviewer.toolbar.next": "Sonra ki Resim (Kisa Yol: Sag Ok)",
    "photoviewer.toolbar.last": "Son Resmi Goster (End Tusu)",
    "photoviewer.toolbar.email": "Mail Gonder",
    "photoviewer.toolbar.permalink": "Ayri Pencere de Ac",
    "photoviewer.toolbar.close": "Kapat (Kisa Yol: Esc Tusu)",
    "photoviewer.email.subject.photo": "Photo",

    "gallery.nophotos": "Resim Yok",
    "gallery.thumbs.start": "Basla",
    "gallery.thumbs.end": "Bitir",
    "gallery.toolbar.first": "Ilk Resim",
    "gallery.toolbar.prev": "once ki Resim",
    "gallery.toolbar.view": "Resim Gorunumu",
    "gallery.toolbar.next": "once ki Resim",
    "gallery.toolbar.last": "Son Resim",
    "gallery.view.full": "Tam ekran",
    "gallery.view.photo": "Sadece Resmi Goster",
    "gallery.view.text": "Sadece Aciklamayi Goster",
    "gallery.view.close": "Pencereyi Kapat"
};

var agent = navigator.userAgent.toLowerCase(); var IE = (agent.indexOf("msie") != -1 && agent.indexOf("opera") == -1); var IE7 = (agent.indexOf("msie 7") != -1); var IE8 = (agent.indexOf("msie 8") != -1); var IE9 = (agent.indexOf("msie 9") != -1); var OPERA = (agent.indexOf("opera") != -1); var SAFARI = (agent.indexOf("safari") != -1); var FIREFOX = (agent.indexOf("gecko") != -1); var STRICT_MODE = (document.compatMode == "CSS1Compat"); var _DOMAIN = undefined; var GALLERY_W = 650; var GALLERY_H = 530; if (USE_GOOGLE_MAPS == undefined) { var USE_GOOGLE_MAPS = true; }
...
function isHosted() {
    var host = document.location.host; if (host == undefined)
        host = ""; return ((host.indexOf("atasehir.bel.tr") == -1 || host.indexOf("yeni.atasehir.bel.tr") != -1) && host.indexOf("rtvslo.si") == -1 && host != "localhost" && !checkDomain());
}
