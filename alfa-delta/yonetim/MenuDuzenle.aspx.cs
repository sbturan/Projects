...
public partial class yonetim_MenuDuzenle : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Adapter = new SqlDataAdapter("SELECT * FROM icerik where dil='tr'", baglanti);
            ...
            lie.Text = "Alt Sayfa Seçiniz";

            lie.Value = "-1";
          
            DropDownList2.Items.Add(lie);
         ...
         //   DropDownList2.Text = "Alt Sayfasını Seçiniz";
