...
public class UrunInfo
{
    ...
    public UrunInfo(int id,float fiyat,string ktg,string marka, string adi,float kdv_orani, DateTime eklenme_tarih ,string dil,int para_birimi,int kritik_stokmiktar,int indirim,int ktg_id,int seviye, bool yayin_durumu,string icon,string pdf,int mrk_id,int stok_miktar)
    {
        this._ktg = ktg;
        this._marka = marka;
        this._id = id;
    ...
    public UrunInfo(SqlDataReader dr)
    {
